...
- Extract business logic (not UI) into composables (`useXxx.js`/`.ts`). A composable returns reactive state + methods, the component stays thin — just rendering and calling the composable.
